...
class ToolsGallery {
        ...
        card.innerHTML = `
            <div class="tool-image-container">
                ...
                <button class="favorite-btn" data-tool-name="${tool.name}" title="Add to favorites">
                    <svg class="heart-icon" width="20" height="20" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    renderTagButtons() {
        ...
        // Add favorites tag button
        const favoritesButton = document.createElement('button');
        favoritesButton.className = 'tag-filter-btn favorites-tag-btn';
        favoritesButton.textContent = 'favorites';
        favoritesButton.setAttribute('data-tag', 'favorites');
        
        favoritesButton.addEventListener('click', () => {
            this.toggleFavoritesFilter();
        });
        
        this.tagButtonsContainer.appendChild(favoritesButton);
        this.favoritesBtn = favoritesButton; // Update reference for other methods
    }
